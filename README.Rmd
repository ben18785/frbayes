...
You can install the development version of frbayes from [GitHub](https://github.com/) with:
...
We now assess the likelihood using the `log_probability` function. We show how the log-likelihood
