...
#'
#' Functional response dataset for \emph{Bythotrephes} spp. (water fleas) preying on prey items of different sizes.
#'
#' @docType data
#' @name bythotrephes
...
#' @source Daniel Barrios-O'Neill's Frair GitHub: https://github.com/dpritchard/frair
#' @examples
#' data(bythotrephes)
"bythotrephes"
